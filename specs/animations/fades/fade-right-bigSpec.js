describe('Fade right big animation', function() {
  var prefixes = {
  ...
  it("should fade-right-big in", function(done) {
  ...
  it("should fade-right-big out", function(done) {
    inject(function($animate, $compile, $document, $rootScope, $rootElement, $window, $timeout) {
      var element = $compile('<div class="fx-fade-right-big">fade-right-big</div>')($rootScope);
      $rootElement.append(element);
      angular.element($document[0].body).append($rootElement);
  ...
  it("should fade-right-big move", function(done) {
    inject(function($animate, $compile, $document, $rootScope, $rootElement, $window, $timeout) {
      var element = $compile('<div class="fx-fade-right-big">fade-right-big</div>')($rootScope);
      $rootElement.append(element);
      angular.element($document[0].body).append($rootElement);

describe('zoom right animation', function() {
  var prefixes = {
  ...
  it("should zoom-right in", function(done) {
  ...
  it('should zoom-right out', function(done){
    inject(function($animate, $compile, $document, $rootScope, $rootElement, $window, $timeout) {
      var element = $compile('<div class="fx-zoom-right">zoom-right</div>')($rootScope);
      $rootElement.append(element);
      angular.element($document[0].body).append($rootElement);
  ...
  it('should zoom-right move', function(done){
    inject(function($animate, $compile, $document, $rootScope, $rootElement, $window, $timeout) {
      var element = $compile('<div class="fx-zoom-right">zoom-right</div>')($rootScope);
      $rootElement.append(element);
      angular.element($document[0].body).append($rootElement);
